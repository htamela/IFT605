 ...
 * 
 */
@WebServiceClient(name = "ServiceImplService", targetNamespace = "http://service.soap.ift605/", wsdlLocation = "http://localhost:9999/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICEIMPLSERVICE_QNAME = new QName("http://service.soap.ift605/", "ServiceImplService");
    ...
    public IService getServiceImplPort() {
        return super.getPort(new QName("http://service.soap.ift605/", "ServiceImplPort"), IService.class);
    }
    ...
    public IService getServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.soap.ift605/", "ServiceImplPort"), IService.class, features);
    }
